...
# apt-get install apache2 librrds-perl libconfig-general-perl libhtml-parser-perl libregexp-common-perl
\end{lstlisting}
...
\begin{lstlisting}[frame=single,caption=Collectd.conf,backgroundcolor=\color{gray},breaklines=true,numbers=left,]
